<?php
	...
	$script='
        ...
        $('.$comillas.'#grafica'.$comillas.').highcharts({
			...
			series:[';
	$cont.='<h3 style="background:#e9e9e9;padding-top:7px;padding-bottom:7px;width:100%;text-align:center;">Tiempo Promedio empleado por Visitas</h3>
			<center>';
	...
	if($total == 0){
		$cont = '
			<h3 style="background:#e9e9e9;padding-top:7px;padding-bottom:7px;width:100%;text-align:center;">Tiempo Promedio empleado por Visitas</h3>
