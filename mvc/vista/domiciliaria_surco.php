<?php
				...
				<section id="panel_01" class="acordeon">
					<div>
						...
						<article class="tab-height1">
							<table class="tabla" cellpadding="2" cellspacing="8">
								<tr>
					...
					<div>
						...
						<article class="tab-height1">
							<table class="tabla" cellpadding="2" cellspacing="8">
								...
								<tr style="background:#d3d3d3;" bordercolor="#000">
									<th>Hora<th>
									<th>PA<th>
									<th>FC<th>
									<th>FR<th>
	...
	$cont='
		<fieldset style="font-size:15px;font-weight:bold;">
			<legend align="center">Sistema Único de Referencia y Contrarreferencia</legend>
			<table>
				<tr>
					<td>
						<table>
							<tr>
								<td colspan="3">Fulanito de Tal</td>
							</tr>
							<tr>
								<td>4-125-634</td>
								<td>O+</td>
													...
													<tr>
														...
														<td>
															<table>
																...
																<tr><td><textarea style="width:125px;height:40px;"></textarea></td></tr>
															</table>
														</td>
														<td>
															<table>
						...
						<div class="contenedor-tabs">
							...
							<span class="diana" id="diag"></span>
								<div class="tab">
									...
									<div>
										<table width="90%" class="showinput" cellpadding="0" cellspacing="0">
											<tr>
												<td>
													<table class="tabla-datos">
														<tr>
														...
														<tr>
															<td colspan="2" class="showinput"><textarea style="width:260px;height:40px;"></textarea></td>
														</tr>
													</table>
												</td>													
												<td>
													<table class="tabla-datos" class="showinput">
														<tr>
															<td colspan="2">Manejo y Tratamiento:</td>
														</tr>
														<tr rowspan="3">
															<td colspan="2" class="showinput"><textarea style="width:270px;height:87px;"></textarea></td>
														</tr>
													</table>
												</td>
											</tr>
								...
								<div class="tab">
									...
									<div>
										<table class="tabla-datos" class="showinput">
											...
											<tr>
												<td colspan="7"><textarea style="width:550px;height:70px;"></textarea></td>
											</tr>
										</table>
									</div>
								</div>		
